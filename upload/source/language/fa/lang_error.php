...
$lang = array
(
	'System Message'		=> 'تنظیمات اصلی سایت',//'站点信息',
	...
	'file_upload_error_-101'	=> 'آپلود ناموفق بود فایل آپلود وجود ندارد یا نامعتبر است لطفا بازگردید.',//'上传失败！上传文件不存在或不合法，请返回。',
	'file_upload_error_-102'	=> 'آپلود ناموفق بود نوع فایل آپلود تصویری نیست لطفا بازگردید.',//'上传失败！非图片类型文件，请返回。',
	'file_upload_error_-103'	=> 'آپلود ناموفق بود فایل قابل نوشتن نیست یا نوشتن ناموفق بود لطفا بازگردید.',//'上传失败！无法写入文件或写入失败，请返回。',
	'file_upload_error_-104'	=> 'آپلود ناموفق بود فرمت فایل تصویری قابل شناسایی نیست لطفا بازگردید.',//'上传失败！无法识别的图像文件格式，请返回。',
);
