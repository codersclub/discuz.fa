...
(
	'hello'				=> 'سلام',//'你好',
	'moderate_member_invalidate'	=> 'عدم تایید',//'否决',
	'moderate_member_delete'	=> 'حذف',//'删除',
	'moderate_member_validate'	=> 'قبول کردن',//'通过',


	'get_passwd_subject'	=> 'کمک در مورد بازیابی پسورد',//'取回密码说密明',
	'get_passwd_message'	=> '
<p>{username},
این ایمیل از طرف {bbname}. ارسال شده است</p>
...
<p>
----------------------------------------------------------------------<br />
<strong>دستور العمل بازیابی پسورد</strong><br />
----------------------------------------------------------------------</p>
</p>
...
<p>بعد از باز شدن صفحه پسورد جدید خود را وارد کنید, سپس میتوانید از پسورد جدید استفاده کنید.
هرموقع خواستید میتوانید از طریق پنل کاربری رمز خود را عوض کنید.</p>

<p>این درخواست از طریق آیپی زیر ارسال شده است {clientip}</p>
...
{siteurl}</p>',
	...
	'email_verify_subject'	=> 'تایید آدرس ایمیل',//'Email 地址验证',
...
<br />
----------------------------------------------------------------------<br />
<strong>دستور العمل فعال سازی اکانت کاربری</strong><br />
----------------------------------------------------------------------<br />
<br />

<p>برای فعال سازی اکانت لطفا روی لینک زیر کلیک کنید<br />
