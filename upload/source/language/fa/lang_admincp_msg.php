...
$lang = array (
	...
	'plugins_install_succeed'		=> 'Plugin successfully installed!<br />In order to use this plug-in normally, you may also need to upload or modify the appropriate file or template. Please see the installation instructions of this plug-in for details.<br /><br /><a href="https://addon.dismall.com?view=plugins">Click here to return to the app center</a><br />',//'插件成功安装！<br />为了正常使用此插件，您可能还需要上传或修改相应的文件或模板，详情请查看本插件的安装说明',
	...
	'plugins_upgrade_succeed'		=> 'Plug-in successfully upgraded to version {toversion}<br /><br /><a href="https://addon.dismall.com?view=plugins">Click here to return to the app center</a><br />',//'插件成功更新到 {toversion}',
	...
	'styles_install_succeed'		=> 'The Style installed successfully!<br /><br /><a href="https://addon.dismall.com?view=templates">Click here to return to the app center</a><br />',//'界面方案安装完毕！<br /><br /><a href="https://addon.dismall.com?view=templates">Click here to return to the app center</a><br />',
