...
$lang = array(
	...
	'FileType'		=> 'نوع فایل',//'文件类型',
	'MimeType'		=> 'Mime Type',//'文件格式',
	'FileSize'		=> 'حجم فایل',//'文件大小',
	'FileDateTime'		=> 'زمان فایل',//'时间戳',
	'ImageDescription'	=> 'توضیح تصویر',//'图片说明',
	'auto'			=> 'خودکار',//'自动',
	...
	'Software'		=> 'نرم افزار',//'创建软件',
	'DateTime'		=> 'Modified Time',//'修改时间',
	'Artist'		=> 'نویسنده',//'作者',
	'YCbCrPositioning'	=> 'YCbCr Positioning',//'YCbCr位置控制',
	'Copyright'		=> 'کپی رایت',//'版权',
	'Photographer'		=> 'عکاس',//'摄影版权',
	'Editor'		=> 'ویرایش کننده',//'编辑版权',
	...
	'ExifImageLength'	=> 'Exif Image Width',//'Exif图像像压宽度',
