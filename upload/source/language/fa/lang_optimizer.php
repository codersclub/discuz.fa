...
/*3.1*/	'optimizer_inviteregister_tip'			=> 'Enable registration by invitation code, Set a list of restricted areas for fet invitation code. Suitable for local communities.',//'注册项中开启邀请注册后,设置不受邀请码限制的地方列表,适合地方社区设置',
/*3.1*/	'optimizer_iniviteregister_normal'		=> 'Detected normal registration setting',//'检测设置正常',
/*3.1*/	'optimizer_emailregister_normal'		=> 'Detected normal settings, please check the mailserver works ok',//'已设置该项,请查看是否配置邮件服务器',
/*3.1*/	'optimizer_emailregister_tip'			=> 'This setting can enhance the user quality',//'此设置可以提升用户质量',
/*3.1*/	'optimizer_pwlength_need'			=> 'Minimum password length is too low, it is unsafe!',//'密码最小长度过低，不安全',
/*3.1*/	'optimizer_pwlength_no_need'			=> 'Detected after testing that the password length is set to normal',//'经检测密码长度设置正常',
/*3.1*/	'optimizer_regmaildomain_need'			=> 'Need to optimize the blacklist',//'需要优化黑名单列表',
/*3.1*/	'optimizer_regmaildomain_tip'			=> 'You can set restrictions for mail domains at registration to prevent a spam',//'可以设置邮箱域名限制阻止垃圾注册',
/*3.1*/	'optimizer_ipregctrl_no_need'			=> 'Registration IP restriction list is set',//'已经设置了限时注册IP列表',
/*3.1*/	'optimizer_ipregctrl_tip'			=> 'When you see a lot of malicious registrations frome some IP range, you can add this IP address or range to the IP black list',//'当有某些IP段在恶意注册时，可以将恶意的IP地址录入',
/*3.1*/	'optimizer_newbiespan_no_need'			=> 'Newbie aprobation period has been set',//'已经设置了见习时间',
/*3.1*/	'optimizer_newbiespan_need'			=> 'Aprobation period can be set for more secure',//'设置一下见习时间更安全',
/*3.1*/	'optimizer_editperdel_no_need'			=> 'The setting "No edit after delete" has been set',//'已经设置了此设置项',
/*3.1*/	'optimizer_editperdel_need'			=> 'Need to be optimized',//'需要优化此项',
/*3.1*/	'optimizer_recyclebin_no_need'			=> 'Forum Recycle Bin have been enabled',//'版块都已经开启回收站了',
/*3.1*/	'optimizer_recyclebin_need'			=> 'Forum Recycle Bin is NOT enabled<br>{forumdesc}',//'版块没有开启回收站<br>{forumdesc}',
/*3.1*/	'optimizer_forumstatus_no_need'			=> 'No hidden forums or hidden blocks have access permissions set',//'无隐藏版块或者隐藏版块都已经设置了访问权限',
/*3.1*/	'optimizer_forumstatus_need'			=> 'Hidden block have no access permissions set<br>{forumdesc}',//'隐藏版块还没有设置访问权限<br>{forumdesc}',
/*3.1*/	'optimizer_usergroup9_no_need'			=> 'Limited user group membership is set to normal',//'限制会员用户组设置正常',
/*3.1*/	'optimizer_usergroup9_need'			=> 'Please close these options "{desc}"',//'请关闭 "{desc}" 这些选项',
/*3.1*/	'optimizer_usergroup4_need'			=> 'Please close these options "{desc}"',//'请关闭 "{desc}" 这些选项',
/*3.1*/	'optimizer_usergroup5_need'			=> 'Please close these options "{desc}"',//'请关闭 "{desc}" 这些选项',
/*3.1*/	'optimizer_usergroup6_need'			=> 'Please close these options "{desc}"',//'请关闭 "{desc}" 这些选项',
/*3.1*/	'optimizer_usergroup_need_allowsendpm'		=> 'Allow to send PM',//'是否允许发短消息',
/*3.1*/	'optimizer_usergroup_need_allowposturl'		=> 'Allow to publish external URL',//'是否允许发站外URL',
/*3.1*/	'optimizer_usergroup_need_allowgroupposturl'	=> 'Whether to allow this group to publish external URL',//'群组是否允许发站外URL',
/*3.1*/	'optimizer_usergroup_need_allowpost'		=> 'Allow New Threads',//'允许发新话题',
/*3.1*/	'optimizer_usergroup_need_allowreply'		=> 'Allow Post Replies',//'允许发表回复',
/*3.1*/	'optimizer_usergroup_need_allowdirectpost'	=> 'Allow direct posting',//'允许直接发帖',
/*3.1*/	'optimizer_usergroup_need_allowgroupdirectpost'	=> 'Allow direct posting for groups',//'群组允许直接发帖',
/*3.1*/	'optimizer_usergroup4_no_need'			=> 'R/O user group setting is normal',//'禁止发言用户组设置正常',
/*3.1*/	'optimizer_usergroup5_no_need'			=> 'No-access user group setting is normal',//'禁止访问用户组设置正常',
/*3.1*/	'optimizer_usergroup6_no_need'			=> 'Disabled IP user group setting is normal',//'禁止IP用户组设置正常',
/*3.1*/	'optimizer_cloudsecurity_no_need'		=> 'Waterproof wall is turned on',//'防水墙已开启',
/*3.1*/	'optimizer_cloudsecurity_need'			=> 'Waterproof wall can effectively prevent spam, improve a site content quality, reduce a management cost. It is highly recommended to install this application.',//'防水墙可以有效的防止垃圾帖,提升网站内容质量,降低管理成本，非常建议安装此应用',
/*3.1*/	'optimizer_cloudsecurity_setting_need'		=> 'Waterproof wall settings need to be modified',//'防水墙设置被修改',
/*3.1*/	'optimizer_attachexpire_need'			=> 'This setting can play an anti-hotlinking role',//'设置后可以起到防盗链的作用',
/*3.1*/	'optimizer_attachexpire_no_need'		=> 'The setting is normal',//'已经设置了此项',
/*3.1*/	'optimizer_attachrefcheck_need'			=> 'This setting can play an anti-hotlinking role',//'设置后可以起到防盗链的作用',
/*3.1*/	'optimizer_attachrefcheck_no_need'		=> 'The setting is normal',//'已经设置了此项',
/*3.1*/	'optimizer_loginpwcheck_need'			=> 'Weak password detection is disabled',//'弱密码登录检测未开启',
/*3.1*/	'optimizer_loginpwcheck_no_need'		=> 'Weak password detection is enabled',//'弱密码登录检测已开启',
/*3.1*/	'optimizer_loginoutofdate_need'			=> 'Abnormal login detection is disabled',//'异常登录检测未开启',
/*3.1*/	'optimizer_loginoutofdate_no_need'		=> 'Abnormal login detection is enabled',//'异常登录检测已开启',
/*3.1*/	'optimizer_postqqonly_need'			=> 'Bind QQ before posting is disabled',//'发帖需要绑定QQ号检测未开启',
/*3.1*/	'optimizer_postqqonly_no_need'			=> 'Bind QQ before posting is enabled',//'发帖需要绑定QQ号检测已开启',
/*3.1*/	'optimizer_aggid_need'				=> '"Administrator, Super Moderator, Moderator must have QQ bound" is disabled',//'“管理员，超级版主，版主”QQ登录检测未开启',
/*3.1*/	'optimizer_aggid_no_need'			=> '"Administrator, Super Moderator, Moderator must have QQ bound" is enabled',//'“管理员，超级版主，版主”QQ登录检测已开启',
/*3.1*/	'optimizer_eviluser_need'			=> 'Waterproof wall detected violated users, Please process ASAP',//'防水墙识别到违规用户，请及时处理',
/*3.1*/	'optimizer_eviluser_no_need'			=> 'No violated users found',//'未发现违规用户',
/*3.1*/	'optimizer_white_list_need'			=> 'You have set up a waterproof wall whitelist. Whitelist spamming users markers is yet not processed, please be careful.',//'您设置了防水墙白名单，白名单用户发垃圾贴不被处理，请慎重',
/*3.1*/	'optimizer_white_list_no_need'			=> 'White list is not set',//'未设置白名单',
/*3.1*/	'optimizer_security_daily_need'			=> 'Enabling the daily waterproof wall optimization can clear the traces of deleted posts',//'开启防水墙每日优化，可清除删帖后首页痕迹',
/*3.1vot*/	'optimizer_security_daily_no_need'			=> 'The scheduled task is enabled',//'该计划任务已开启',
);
