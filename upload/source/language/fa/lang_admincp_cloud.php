...
/*3.1*/	'cloud_change_info'		=> 'Change Info',//'变更信息',
/*3.1*/	'cloud_change_qq'		=> 'Change bound QQ',//'更换绑定QQ',	
...
/*3.1*/	'security_reopen'		=> 'Your site is not successfully opened the waterproof wall, please <a href="'.ADMINSCRIPT.'?action=cloud&operation=security&anchor=reopen">Re-Open</a>',//'您的站点未成功开通防水墙，请<a href="'.ADMINSCRIPT.'?action=cloud&operation=security&anchor=reopen">再次开通</a>',	
...
/*3.1*/	'security_reopen_list'			=> 'Re-Opened',//'再次开通',	
